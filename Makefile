TARGET = CR4
SRCS = cubicalripser_4dim.cpp dense_cubical_grids.cpp birthday_index.cpp columns_to_reduce.cpp simplex_coboundary_enumerator.cpp union_find.cpp write_pairs.cpp compute_pairs.cpp
OBJS = cubicalripser_4dim.o dense_cubical_grids.o birthday_index.o columns_to_reduce.o simplex_coboundary_enumerator.o union_find.o write_pairs.o compute_pairs.o
